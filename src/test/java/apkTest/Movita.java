...
@Test
public void movita() throws MalformedURLException {
...
driver.get("http://movita.com.tr:9045/");
    }
    @Test
    public void ScrollDualingo() throws MalformedURLException, InterruptedException {
        ...
        desiredCapabilities.setCapability(MobileCapabilityType.PLATFORM_VERSION, "10.0");
        desiredCapabilities.setCapability(MobileCapabilityType.AUTOMATION_NAME, "UiAutomator2");
        desiredCapabilities.setCapability(MobileCapabilityType.APP, "C:\\Users\\Mehmet\\IdeaProjects\\appiumWorkShop\\src\\test\\java\\AppiumClassFirst\\APP\\mov.apk");
        desiredCapabilities.setCapability("fullreset", "true");
        // ! Yukarıdaki path i kendinize göre ayarlayınız.
        AndroidDriver<AndroidElement> driver = new AndroidDriver<>(new URL("http:127.0.0.1:4723/wd/hub"), desiredCapabilities);
